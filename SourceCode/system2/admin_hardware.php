...
$query = "SELECT id, hardware_name, address, owners_name, image FROM registration_hardware ORDER BY id";
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin_hardware.php">Home</a></li>
          <li class="breadcrumb-item active">List of Hardware</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
