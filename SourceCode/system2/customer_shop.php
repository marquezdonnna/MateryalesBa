...
<div class="container">
      <?php
         $total_images = 0;
         $select_properties = $conn->prepare("SELECT * FROM `registration_hardware` ORDER BY date DESC LIMIT 100");
      ...
      <div class="col">
        <div class="card mt-4 custom-card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <a href="view_shop.php?get_id=<?= $fetch_property['id']; ?>" class="btn btn-custom border-custom">
              <i class="bi bi-shop"></i>
              Visit Store
            </a>
          </div>
          <div class="card-body d-flex flex-column align-items-center">
            <img src="uploads/<?= $fetch_property['image']; ?>" alt="<?php echo $fetch_property['image']; ?>" class="card-img-top product-image-small rounded-circle">
            <span class="hardware-name"><?= $fetch_property['hardware_name']; ?></span>
          </div>
        </div>
      </div>
  </div>
