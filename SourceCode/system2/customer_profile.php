    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="profile"class="rounded-circle">
              <span><h2><?= $fetch_profile['name']; ?></h2></span>
              <span>Customer</span>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?= $fetch_profile['name']; ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Gender</div>
                <div class="col-lg-9 col-md-8"><?= $fetch_profile['gender']; ?></div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8"><?= $fetch_profile['contact']; ?></div>
              </div>
